      ...
      const fetchMovies = async () => {
        try {
          const response = await fetch(
            `https://api.themoviedb.org/${movieType}?api_key=4113f3ad734e747a5b463cde8c55de42&language=en-US&page=${page + 1}`
          );
          if (response.ok) {
        ...
        <Box width="100%" overflow="auto">
            <StyledTable>
                ...
                {allMovies.map((subscriber, index) => (
                    ...
                    <TableCell align="center">{subscriber.title || subscriber.name}</TableCell>
                    <TableCell align="center">
                        {subscriber.overview && subscriber.overview.substring(0, 17) + "..."}
                    </TableCell>
                    <TableCell align="center">{subscriber.release_date || subscriber.first_air_date}</TableCell>
